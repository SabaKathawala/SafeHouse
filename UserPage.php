...
<?php
 ...
 ?>
  <div id = 'load' style='display:none;position:fixed;left:0;top:0;width:100%;z-index:1000;height:100%;background-color: rgba(0,0,0,0.1);' > 
    <i style='position:fixed;left:55%;top:60%;font-size:55px;color:#72c02c;;'class="fa fa-spinner fa-spin"></i>
  </div>                             
  
  <div style='margin-top:158px;border-top:solid 4px #72c02c;'></div>
      ...
      <div class='col-md-8 col-xs-8'>
        ...
        <div id='login_div' class='format edit_blocks'>
          ...
          <table>
            ...
            <tr>
              <td><img src='images/google+.jpg' class='img img-responsive otl' id='google' /></td>
              <td><img src='images/facebook.jpg' class='img img-responsive otl' id='facebook' /></td>
            </tr>
          </table>
        </div>
        <!-- Login -->
  ...
  $("#form_add").validate({
    ...
    submitHandler: function(form) {
      ...
      else
      {
        ...
        if((user_email.indexOf("gmail")!= -1 && category=="google") || (category=="facebook"))
        {
          $("#load").show();

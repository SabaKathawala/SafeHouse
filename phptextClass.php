...
{	
	...
	{
		/* settings */
		$font = './fonts/fonts/ParkLaneNF.ttf';/*define font*/
	...
	{	
		/* Settings */
		$text=$this->random();
		$font = './fonts/fonts/Oregon LDO Vanishing Bold Oblique_0.ttf';/* font */
		$textColor=$this->hexToRGB($textColor);	
	...
	protected function ImageTTFCenter($image, $text, $font, $size, $angle = 30) 
	{
		$xi = imagesx($image);
		$yi = imagesy($image);
